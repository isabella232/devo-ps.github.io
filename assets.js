...
require.register("highlightjs/highlight.js", function(exports, require, module){
...
/**
 * Links giving the focus to the registration form
 */
$('a[href="#subscription"]').click(function () {
    $('#mce-EMAIL').focus();
    console.log('sdf');
});
...
require.alias("highlightjs/highlight.js", "boot/deps/highlightjs/highlight.js");
