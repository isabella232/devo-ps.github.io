...
Let's say you want to monitor all processes managed by PM2, as well as the status of the machine they run on (and making a nice Angular app to consume this API :)
